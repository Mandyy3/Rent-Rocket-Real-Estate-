...
const Connect = () => {
  return (
    <div data-aos="zoom-in" className='relative flex bg-sky-300 mt-16 sm:mt-40 mb-16 sm:mb-40 mx-[5%] px-[4%] sm:px-[6%] py-4 sm:py-10 rounded-[10px] items-center' id="connect">
