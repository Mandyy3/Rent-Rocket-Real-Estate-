            ...
            <div className='hidden md:flex ml-auto '>
                ...
                <Link href='/search' >
                    <div className='relative flex justify-center self-center mr-7'>
                        <a className='md:text-lg lg:text-spSize2  hover:text-sky-400 transition duration-500 ease-in-out'>Search Rentals</a>
                        <span className="animate-ping h-2 w-2 rounded-full bg-blue-700 opacity-75"></span>
                    </div>
                </Link>
                <a href='https://www.linkedin.com/in/mandeep-singh-6135b1237//'target={'_blank'} rel="noreferrer">
                    <button className="border flex border-sky-600 rounded px-7 py-2 cursor-pointer hover:bg-sky-300 transition duration-500 ease-in-out text-sky-600 self-center text-contactSize hover:text-white">
                        Contact Us
                    </button>
                </a>
            </div>
