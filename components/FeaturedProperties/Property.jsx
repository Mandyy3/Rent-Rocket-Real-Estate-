        ...
        <Link href={`/property/${externalID}`} passHref>
            <div data-aos="zoom-in-down" className='flex flex-col w-full sm:w-1/2 lg:w-1/3 pt-0 justify-start cursor-pointer px-3 mb-5'>
                <div className='relative'>
                    ...
                    <div className="relative w-full h-[320px]  sm:h-[180px] md:h-[180px] lg:h-[190px] xl:h-[230px] 2xl:h-[280px]
                    ">
                        <Image
                ...
                <div className='mt-4'>
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold text-orange-500 mt-3 mb-5">$ {price}</h3>
                </div>
            </div>
        </Link>
    )
