    ...
    <div className='mx-[5%] mt-20 sm:mt-28' id='ourservices'>
      ...
      <div data-aos="flip-left" className='relative flex flex-col sm:flex-row mt-10 sm:mt-36'>
        ...
        <div className="w-full sm:w-auto order-first sm:order-none mx-auto sm:ml-auto sm:mr-28 lg:mr-32 xl:mr-40">
          <div className='relative w-auto sm:w-[270px] md:w-[350px] lg:w-[470px] xl:w-[530px] 2xl:w-[650px] h-[290px] sm:h-[280px] md:h-[340px] lg:h-[450px] xl:h-[500px] 2xl:h-[560px] z-10 sm:bottom-8 md:bottom-10 sm:left-32'>
            <Image
              alt='house'
              src={"/Images/services-house.jpg"}
              layout="fill"
            />
          </div>
        </div>
